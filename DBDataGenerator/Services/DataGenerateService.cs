...
namespace DBDataGenerator.Services
{
    ...
    public class DataGenerateService
    {
        ...
        /// </summary>
        private int _onceGenerateCount = 500;
        ...
        public async Task<bool> GenerateAndInsertData(string tableName, List<ColumnGenerateDataConfig> columnGenerateDataConfigs, int count = 1)
        {
